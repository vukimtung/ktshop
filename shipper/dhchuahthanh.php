      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <h1 style="text-align: center; color: red; font-weight: bold;">Đơn Hàng Chưa Hoàn Thành</h1>
            </div>
            <div class="box-body">
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                ...
                $stt = 0;
                $sql="SELECT * FROM orders o LEFT JOIN customers c ON o.customer_id = c.id_cust WHERE id_shipper = '$idship' AND status='Đang giao' ORDER BY date_order DESC ";
