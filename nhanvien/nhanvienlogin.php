  ...
  session_start();
    ...
    $_SESSION['password']=$kq['password'];
		...
		if($adminname=$kq['email'] AND $password=$kq['password']){
			header('location: nhanvienindex.php');
		}else{
			header('location: nahnvienlogin.php');
		}
...
<div class="login-box">
  <div class="login-logo">
    <h1 style="color: red;"><strong>Đăng ký Nhân Viên</strong></h1>
  </div>
  <div class="login-box-body">
    <p class="login-box-msg">Điền thông tin để đăng ký</p>
    ...
    <form action="" method="post">
      ...
      <div class="row">
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="register" style="margin-left: 130%;">Đăng nhập</button>
        </div>
      </div>
    </form>
<!-- 
