          ...
          <div class="box">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                $ketqua2=$connect->query($sql2);
                  ...
                  <?php
                      ...
                      $sql3="SELECT * FROM roles WHERE id_r = '$id_q'";
                      $ketqua3=$connect->query($sql3);
                      $kq3=$ketqua3->fetch_assoc();
                      if(($kq3['ten_r']=='Toàn quyền') || ($kq3['ten_r']=='Xóa')){
                    ?>
            ...
            <div class="modal-content" style="border-radius: 5px;">
                ...
                <form role="form" action="xulybackend/taodonnhaphang.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="idnv" value="<?php $idnv = $_SESSION['id_nv']; echo $idnv;?>">
                      <button type="submit" class="btn btn-primary" name="them">Tạo Đơn</button>
                    </div>
              </form>
              <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#themnhacungcap" style="margin-left: 300px; margin-top: -210px;">
                        Thêm nhà cung cấp
                    </button>
                </div>
            </div>
